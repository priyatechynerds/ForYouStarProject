    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.company) {
           // Handle the camera action
            startActivity(new Intent(NavigationDrawer.this,AboutCompany.class));

        } else if (id == R.id.support) {
            startActivity(new Intent(NavigationDrawer.this,Support.class));
...
//            intent=new Intent(Intent.ACTION_VIEW);
//            intent.setData(Uri.parse(url));
            startActivity(new Intent(NavigationDrawer.this,Website.class));
        }else if (id == R.id.bank_details) {
            startActivity(new Intent(NavigationDrawer.this, BankDetails.class));
        }
